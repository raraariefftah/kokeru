                ...
                <div class="card">
                        ...
                        {{-- <div class="form-row align-items-center pt-3 pl-4">
                            ...
                            {{-- <div class="col-auto">--}}
                                {{-- <a type="button" class="btn btn-primary"
                                    ...
                                    {{-- style="background-color: rgb(36, 119, 47)"><i
                                        class="nav-icon fas fa-file">--}}
                                        {{-- Print as Excel
                                    </i></a>--}}
                                {{-- </div>--}}
                    ...
                    <form role="form" action="{{ url('/manager/laporan_daftar_tugas') }}" method="get">
                        ...
                        <div class="row pt-3 ml-3">
                            <!-- kolom -->
                            <div class="col-md-2">
                                {{-- default tanggal hari ini / pakek kalender untuk
                                memilih tanggal sebelumnya --}}
                                <label for="datepicker">Pilih Tanggal</label>
                                {{-- <input type='text'
                                    class="datepicker-here form-control" data-position="right top"
                                    --}} {{-- id="datepicker"
                                    name="datepicker" data-language='en'>--}}
                    ...
                    <div class="container-fluid pr-4">
                        <div class="row pt-4 text-center">
                            <div class="col">
                                <h5 style="font-weight: bold">Laporan Harian Kebersihan dan Kerapihan Ruangan Gedung
                                    Bersama
                                    Maju</h5>
