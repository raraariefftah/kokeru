                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="status1" name="status" class="custom-control-input" value="SUDAH" {{old('status') === 'SUDAH' ?? 'checked'}}>
                                        <label class="custom-control-label" for="status1">SUDAH</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="status2" name="status" class="custom-control-input" value="BELUM" {{old('status') === 'BELUM' ?? 'checked'}}>
